...
| W3-M | Worker M | `src/local-bridge/src/agent/**`, `src/local-bridge/src/api/agent*` | project file format | mock agent success/failure tests |
| W3-N | Worker N | `src/studio-web/src/features/agent-panel/**` | bridge adapters | agent patch E2E |
